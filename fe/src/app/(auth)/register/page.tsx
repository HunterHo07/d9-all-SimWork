...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.auth.register(email, password, passwordConfirm, name);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden p-4">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full bg-purple-500/10 blur-[100px] z-0"></div>
      <div className="absolute bottom-0 right-0 w-[300px] h-[300px] rounded-full bg-blue-500/10 blur-[80px] z-0"></div>
      ...
      <FadeIn>
        <Card className="w-full max-w-md bg-black/40 backdrop-blur-sm border border-white/10">
          ...
          <CardFooter>
            <div className="text-center w-full text-white/70 text-sm">
